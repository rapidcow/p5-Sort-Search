...
here.  Despite examples are provided for both, keep in
...
but it save you an extra comparison.  If you also need
the array element, use the third field C<$elt>, which is
